...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "N3 SmartKlimat renoverar och bygger i hela Stockholm — totalrenovering, badrum, kök, tak, fasad och altan. Fast pris, egen projektledare och 5 års garanti på arbetet." },
      { name: "author", content: "N3 SmartKlimat" },
      { property: "og:title", content: "N3 SmartKlimat – Renovering & Bygg i Stockholm" },
      { property: "og:description", content: "N3 SmartKlimat renoverar och bygger i hela Stockholm — totalrenovering, badrum, kök, tak, fasad och altan. Fast pris, egen projektledare och 5 års garanti på arbetet." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "N3 SmartKlimat – Renovering & Bygg i Stockholm" },
      { name: "twitter:description", content: "N3 SmartKlimat renoverar och bygger i hela Stockholm — totalrenovering, badrum, kök, tak, fasad och altan. Fast pris, egen projektledare och 5 års garanti på arbetet." },
