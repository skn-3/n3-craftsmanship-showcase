...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "N3 SmartKlimat" },
      { name: "description", content: "Hantverk med skandinavisk precision" },
      { name: "author", content: "N3 SmartKlimat" },
      { property: "og:title", content: "N3 SmartKlimat" },
      { property: "og:description", content: "Hantverk med skandinavisk precision" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "N3 SmartKlimat" },
